#!/usr/bin/python3
"""Module that defines a Rectangle class with printable representation.

This module provides a Rectangle class that can be printed as '#' shapes.
"""


class Rectangle:
    """Represents a rectangle with printable character representation.
