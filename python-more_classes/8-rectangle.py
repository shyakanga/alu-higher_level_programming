#!/usr/bin/python3
"""Module that defines a Rectangle class with static area comparison.

This module provides a static method to compare two rectangle areas.
"""


class Rectangle:
    """Represents a rectangle capable of static area comparison.
